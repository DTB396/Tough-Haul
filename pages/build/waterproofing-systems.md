---
layout: build-page
title: "Build Phase 3: Waterproofing Systems"
...
## 1) Surface-Applied (Bonded) Waterproofing Systems
...
* Modern showers
* Curbless designs
* Custom site-built pans or pre-sloped trays

**Critical requirements:**

* Continuous membrane from walls to floor to drain
* Full bond at the drain flange
* Proper treatment of corners and penetrations

---

## 2) Traditional Liner (Clamping Drain) Systems
...
* Saturated mortar beds
* Blocked weep holes
* Long dry times and odor issues
...
* Waterproofing extends above the showerhead height or to the ceiling
* At minimum, waterproofing continues well above all wet zones
...
* Waterproofing applied flat over a sloped requirement
* Membrane stopping short of the drain
* Incompatible drain selection
* Unsealed penetrations
* Relying on tile or grout for water containment
...
How showers contain water at the entry and what changes when curbs are eliminated.
