...
- **File**: `\_includes\head.html`
  **Reference**: `/assets/img/logo/tillerstead-favicon.svg'`

- **File**: `\_includes\head.html`
  **Reference**: `/assets/img/logo/tillerstead-icon-32.png'`

- **File**: `\_includes\head.html`
  **Reference**: `/assets/img/logo/tillerstead-icon-48.png'`
...
- **File**: `\_includes\pattern-showcase.html`
  **Reference**: `/assets/img/tillerstead-work/bathrooms/bathroom-accent-wall-and-shower.webp'`

- **File**: `\_includes\pattern-showcase.html`
  **Reference**: `/assets/img/tillerstead-work/bathrooms/bathroom-accent-wall-and-shower.jpg'`

- **File**: `\_includes\pattern-showcase.html`
  **Reference**: `/assets/img/tillerstead-work/bathrooms/bathroom-accent-wall-detail.webp'`

- **File**: `\_includes\pattern-showcase.html`
  **Reference**: `/assets/img/tillerstead-work/bathrooms/bathroom-accent-wall-detail.jpg'`

- **File**: `\_includes\pattern-showcase.html`
  **Reference**: `/assets/img/tillerstead-work/bathrooms/bathroom-floor-install-progress.webp'`
...
- **File**: `\_data\portfolio_highlights.yml`
  **Reference**: `/assets/img/kitchen-green.jpg`

- **File**: `\_data\portfolio_highlights.yml`
  **Reference**: `/assets/img/bathroom-remodel-2.webp`

- **File**: `\_data\portfolio_highlights.yml`
  **Reference**: `/assets/img/hardwood-room.jpg`
...
5. **Ensure all work photos** are in \ssets/img/tillerstead-work/\ subdirectories

---

_This report was generated by scripts/audit-and-fix-images.ps1_
