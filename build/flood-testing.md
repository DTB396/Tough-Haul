...
## Duration & Observation Requirements
...
1. **Contact your local Construction Office** before waterproofing
2. **Ask specifically:** "Do you require a witnessed flood test?"
...
4. Water level at end (same angle)
5. Area below shower (basement ceiling, crawlspace)
6. Any issues found (if applicable)
...
If water loss or leakage is observed:

### Immediate Steps

1. **Stop** — Do not proceed with tile
2. **Drain** — Remove water carefully
3. **Dry** — Allow membrane to dry completely
4. **Investigate** — Locate the failure point
5. **Repair** — Fix per manufacturer instructions
6. **Re-test** — Verify repair before tile
...
## Why Flood Testing Matters to Homeowners
