...
- **Bonded to substrate** (not isolated)
- **Continuous protection** at all seams, corners, penetrations
- **Load-bearing** (can support tile assembly)
- **Hydrostatic pressure resistance**

## Types of Waterproofing Systems

### Sheet Membranes (Kerdi, RedGard Board, etc.)
...
### Liquid-Applied Membranes (RedGard, AquaDefense, Hydroban)
...
Combination of sheet + liquid (e.g., sheet on pan, liquid on walls).
...
✅ Photograph waterproofing before tile installation  
✅ Record product names, batch numbers  
✅ Save manufacturer spec sheets  
✅ Document flood test results (if performed)

This documentation protects you and your contractor.
