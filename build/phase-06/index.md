...
**TCNA Handbook:** The tile industry's definitive installation guide  
**ANSI A108 Series:** Workmanship standards for tile installation  
**ANSI A118 Series:** Material standards (thin-set, grout, waterproofing)

These aren't suggestions—they're engineered methods proven over decades.
...
Use a **straightedge** (6-10 ft) to check flatness before tiling.

Low spots? Fill with leveling compound.  
High spots? Grind down or use thicker mortar.

## Mortar Selection

Not all thin-set is created equal.
...
This ensures 95%+ coverage and eliminates voids.
...
✅ **Center layout:** Start from center of wall/floor, work outward  
✅ **Symmetry:** Balance cuts on both ends  
✅ **Avoid slivers:** No cuts < 1/3 tile width  
✅ **Plan transitions:** Where does tile meet other materials?
...
1. **Wait for mortar to cure** (24-48 hours minimum)
2. **Remove spacers**
3. **Clean joints** (no dust, debris, or mortar)
4. **Mix grout** (to toothpaste consistency)
5. **Apply at 45° angle** (pack joints fully)
6. **Remove excess** (diagonal passes)
7. **Sponge clean** (minimal water, frequent rinse)
